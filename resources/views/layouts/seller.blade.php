            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    <button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation"
                        ...
                        class="mr-2 text-gray-600 rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-green-200 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-green-700 dark:hover:text-white">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <button id="theme-toggle" type="button"
                        class="text-gray-500 dark:text-gray-400 focus:outline-none rounded-lg text-sm p-2">
                        <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                        </svg>
                        <svg id="theme-toggle-light-icon" class="hidden w-5 h-5" fill="white" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full" src="{{ asset('default_user_photo.png') }}"
                            alt="user photo" />
                        <span
                            class="hidden md:block p-2 text-gray-700 dark:text-gray-300">{{ auth()->user()->name }}</span>
                    </button>
                    <!-- Dropdown menu -->
                        ...
                        <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                            <li>
                                ...
                                <a href="{{ route('seller.mystore') }}"
                                    class="flex items-center gap-2 py-2 px-4 text-sm hover:bg-green-200 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">
                                    <span>
        ...
        <aside
            ...
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                <ul class="space-y-2">
                    ...
                    <li class="rounded">
                        <button type="button"
                            class="categories flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-300 dark:text-white dark:hover:bg-green-800"
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li class="sellers rounded">
                                <a href="{{ route('seller.mystore.categories.index') }}"
                                    class="flex gap-2 items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-200 dark:text-white dark:hover:bg-blue-700">
                                    <span>
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-300 dark:text-white dark:hover:bg-green-800"
                        ...
                        <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                            <li class="products rounded">
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-200 dark:text-white dark:hover:bg-green-700">Products</a>
                            </li>
                            <li class="orders rounded">
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-200 dark:text-white dark:hover:bg-green-700">Orders</a>
                            </li>
                            <li class="stores rounded">
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-green-200 dark:text-white dark:hover:bg-green-700">Stores</a>
                            </li>
                        </ul>
                    </li>
                </ul>
