<div
    class=" border border-green-400 rounded-md bg-gray-300 dark:bg-slate-700 dark:text-gray-300">
            ...
            <div class="p-2">
                @foreach ($cart['products'] as $item)
                    <div class="border border-green-700 rounded-md flex items-center mb-2">
                        ...
                        <form class="remove-from-cart" method="POST" action="{{ route('remove_from_cart', $item->id) }}">
                            @csrf
                            @method('POST')
