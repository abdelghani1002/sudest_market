    ...
    <div class="p-4 md:ml-64 h-screen overflow-y-scroll scrollbar-hidden pt-16">
        ...
        <div class="flex flex-col justify-between w-full overflow-x-scroll scrollbar-hide">
            <div class="px-3 h-full flex flex-col justify-between">
                ...
                @endif
                <h3 class="text-2xl font-semibold mb-4 dark:text-green-300">New Product</h3>
                            ...
                            <div class="md:w-1/2 md:h-full flex flex-col justify-between">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="primary_photo"  id="primary_photo"
                                        ...
                                        value="{{ old('primary_photo') }}" required>
                                    @error('primary_photo')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="md:w-1/2 flex flex-col min-h-full">
                                ...
                                <div class="mb-3 w-full">
                                    ...
                                    <ul class="grid w-full gap-6 grid-cols-2">
                                        <li>
                                            <input type="radio" id="active" checked name="status" value="active"
                                                class="hidden peer" />
                                            <label for="active"
                                ...
                                <div class="flex flex-col flex-grow">
                                    ...
                                    <div class="flex flex-grow">
                                        <textarea name="description" id="description"
                                            class="flex flex-grow form-textarea w-full rounded-md dark:bg-gray-800 dark:text-gray-300" required>{{ old('description') }}</textarea>
                                    </div>
                                    @error('description')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
