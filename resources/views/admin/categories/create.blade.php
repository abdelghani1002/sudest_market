...
<x-admin-layout>
    <div class="px-2 md:ml-64 h-full pt-14 flex flex-row">
        <div class="flex flex-col justify-center w-full">
            <h3 class="w-full text-2xl font-bold text-green-500 text-center">Categories - create</h3>
            ...
            <form action="{{ route('categories.store') }}" method="post" class="w-full flex flex-col items-center"
