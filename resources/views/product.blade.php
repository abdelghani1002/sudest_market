            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    @if (Auth::check() && auth()->user()->hasRole('seller') && Auth::user()->store->products->contains($product))
                        <div class="mt-6 sm:gap-2 sm:items-center sm:flex sm:mt-8 dark:text-gray-300">
                        ...
                        <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                            ...
                            @if ($product->quantity > 0)
                                <form action="{{ route('add_to_cart', $product) }}" method="POST">
                                    ...
                                    @method('POST')
                                    <button
                                        class="text-white sm:mt-0 focus:ring-4 font-medium rounded-lg text-sm flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                        <svg class="w-5 h-5 -ms-2 me-2" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="none" viewBox="0 0 24 24">
